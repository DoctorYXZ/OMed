...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='C:\\code\\Mutation_prediction\\BRAF\\swin_tiny_patch4_window7_224.pth',
                        help='initial weights path')
    parser.add_argument('--lr', type=float, default=0.0005)
    parser.add_argument('--lrf', type=float, default=0.01)
    parser.add_argument('--data_path', type=str, default='C:\\path\\to\\your training set')   # The training set folder should contain two subfolders, BRAF_Mutation and BRAF_Wildtype, with each subfolder containing 224x224 pixel tumor patches
