...
feature_indices = [
    *range(34, 39), *range(57, 59), 79, 110, *range(111, 119),
    *range(129, 139), *range(156, 159), *range(172, 179),
    *range(189, 199), *range(218, 219), *range(231, 239),
    *range(290, 299), *range(309, 319), *range(329, 339),
    *range(367, 379), *range(389, 399), *range(417, 419),
    *range(436, 439), *range(456, 459), *range(494, 499),
    *range(518, 519), *range(537, 539), *range(574, 579),
    *range(597, 599), *range(655, 659), *range(733, 739),
    *range(805, 819), *range(824, 839), 859, *range(866, 879),
    *range(884, 919), *range(970, 979)
]
